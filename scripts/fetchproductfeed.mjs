...
const feedUrl = sitedata.zazzleUrl + '/feed';
...
async function fetchRssFeed() {
  try {
    ...
    // Remove the top-level published date field
    delete feedData.pubDate;
    
    // Convert the Javascript object to JSON and save as a UI component
    fs.writeFileSync('src/customizations/productfeed.json', JSON.stringify(feedData, null, 2));
